...
export const issueRegistry = {
  ...
  visual_asset_missing: define("hard", "revise-scenes", true),
  visual_asset_not_embedded: define("hard", "revise-scenes", true),
  ...
  news_excessive_technical_detail: define("hard", "revise-scenes", true),
  news_jargon_unexplained: define("hard", "revise-scenes", true),
  news_audience_value_missing: define("hard", "revise-scenes", true),
  ...
  news_article_wording_exposed: define("hard", "revise-scenes", true),
  narration_website_reference_exposed: define("hard", "revise-scenes", true),
  ...
  repository_address_exposed: define("hard", "switch-template", true),
  ...
  model_access_details_missing: define("hard", "revise-scenes", true),
  model_access_details_placeholder: define("hard", "revise-scenes", true),
  narration_short: define("hard", "regenerate-draft", true),
  narration_long: define("hard", "regenerate-draft", true),
  narration_scene_overflow: define("hard", "regenerate-draft", true),
  ...
  audio_narration_profile_mismatch: define("hard", "check-environment", false),
  audio_forbidden_provider: define("hard", "check-environment", false),
  audio_acoustic_voice_drift: define("hard", "resynthesize-audio", true),
  audio_nvidia_transport_unstable: define("hard", "resynthesize-audio", true),
  ...
  audio_tail_truncated: define("hard", "remux", true),
  ...
  asset_human_face_exposed: define("hard", "switch-template", true),
