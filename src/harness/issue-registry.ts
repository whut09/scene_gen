...
export const issueRegistry = {
  ...
  audio_entity_mismatch: define("hard", "resynthesize-audio", true),
  audio_number_mismatch: define("hard", "resynthesize-audio", true),
  audio_semantic_mismatch: define("hard", "resynthesize-audio", true),
  audio_segment_cross_talk: define("hard", "resynthesize-audio", true),
