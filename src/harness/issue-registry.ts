...
export const issueRegistry = {
  ...
  hook_value_missing: define("hard", "revise-scenes", true),
  value_revealed_too_late: define("hard", "revise-scenes", true),
  platform_duration_mismatch: define("hard", "regenerate-draft", true),
  scene_information_redundant: define("hard", "revise-scenes", true),
  weak_visual_proof: define("hard", "revise-scenes", true),
  low_visual_change_rate: define("hard", "revise-scenes", true),
  empty_summary_close: define("hard", "revise-scenes", true),
  ...
  generic_transition_filler: define("hard", "revise-scenes", true),
  ...
  repository_address_missing: define("hard", "switch-template", true),
  repository_address_spoken: define("hard", "revise-scenes", true),
  repository_star_count_invalid: define("hard", "retry-stage", true),
  repository_star_not_visible: define("hard", "switch-template", true),
  repository_value_context_missing: define("hard", "revise-scenes", true),
  ...
  source_title_not_preserved: define("hard", "regenerate-draft", true),
  homepage_purpose_missing: define("hard", "revise-scenes", true),
  ...
  tts_contextual_number_pronunciation_invalid: define("hard", "resynthesize-audio", true),
  tts_derived_text_stale: define("hard", "resynthesize-audio", true),
  ...
  audio_scene_boundary_artifact: define("hard", "resynthesize-audio", true),
  audio_repeated_phrase: define("hard", "resynthesize-audio", true),
  speech_alignment_unavailable: define("environment", "retry-stage", true),
  ...
  text_unsafe_zone: define("hard", "switch-template", true),
  text_contrast_low: define("hard", "switch-template", true),
  text_contrast_unverifiable: define("hard", "switch-template", true),
  dark_background_disallowed: define("hard", "switch-template", true),
  text_too_small: define("hard", "switch-template", true),
  text_line_too_long: define("hard", "switch-template", true),
  content_clipped: define("hard", "switch-template", true),
  element_overlap: define("hard", "switch-template", true),
