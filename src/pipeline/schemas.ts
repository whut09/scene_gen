...
export const videoProjectSchema = z.object({
  ...
  audio: z.object({
    ...
    metrics: z.object({
      ...
      ttsTransport: z.string().optional(),
      ttsContinuousStream: z.boolean().optional(),
      voiceConsistencyRetryCount: z.number().int().nonnegative().optional(),
      voiceConsistencyRejectedCandidateCount: z.number().int().nonnegative().optional(),
      voiceRegeneratedSceneIndexes: z.string().optional(),
    }).optional(),
