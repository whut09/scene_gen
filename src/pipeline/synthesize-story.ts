...
const provider = args.provider === "azure" || args.provider === "cloudflare-melotts" || args.provider === "edge" || args.provider === "openai" || args.provider === "f5" || args.provider === "local" || args.provider === "mock" ? args.provider : undefined;
