...
export const kineticTitleTemplate: HtmlTemplateDefinition = {
  ...
  renderHtml: ({ project, scene, width, height, variantId }) => {
    ...
    const body =
      ...
      (isTitle && publicationDate ? '<section class="kt-date"><small>' + escapeHtml(publicationDateLabel) + '</small><strong>' + escapeHtml(publicationDate) + '</strong></section>' : '') +
    ...
    const css =
      ...
      '@keyframes kt-asset-in{from{opacity:0;transform:translateY(38px) scale(.96)}to{opacity:1;transform:none}}@keyframes kt-slam{from{opacity:0;transform:translateY(64px) scale(.92)}to{opacity:1;transform:none}}@keyframes kt-rule-pulse{0%,100%{opacity:.72;transform:scaleX(.94)}50%{opacity:1;transform:scaleX(1)}}';
