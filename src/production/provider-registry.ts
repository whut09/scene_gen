...
function definitions(): ProviderDefinition[] { return [
  { id: "indextts", name: "IndexTTS2 Fixed Reference", capability: "tts", enabled: configured("INDEXTTS_ROOT", "INDEXTTS_MODEL_DIR"), local: true, priorQuality: 0.97, priorCost: 0, priorLatency: 0.75, priorPronunciationAccuracy: 0.96, supportsPortrait: true, commercialUse: true, reason: "Requires local IndexTTS2 weights, reference audio, and compliance with the Bilibili Model Use License scale thresholds", ttsCapabilities: { supportsExplicitPhoneme: true, supportsCustomLexicon: true, supportsVoiceClone: true, supportsSsml: false, supportsStreaming: false, supportsCommercialUse: true, pronunciationControlLevel: "mixed-pinyin", freeQuotaType: "local", estimatedLatency: 0.75, estimatedCost: 0 } },
